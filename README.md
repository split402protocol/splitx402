...
| Merchant SDK cached campaign resolver, operation digests, and receipt outbox | Started |
...
| `@split402/merchant-sdk` | Merchant-side cached campaign resolver, operation digest helpers, durable receipt outbox, and control-plane ingestion retry helpers. |
