...
| Merchant SDK cached campaign resolver, key rotation, payment IDs, operation digests, and receipt outbox | Started |
...
| `@split402/merchant-sdk` | Merchant-side cached campaign resolver, service-key rotation helpers, x402 payment-identifier helpers, operation digest helpers, durable receipt outbox, and control-plane ingestion retry helpers. |
