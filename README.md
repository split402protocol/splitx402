...
| `@split402/router` | Public-alpha capability router with static providers, control-plane route discovery, GET/POST SVM/EVM provider execution, budget enforcement, deterministic ranking, retry/fallback, pay-to wallet checks, and receipt verification for paid tools. |
