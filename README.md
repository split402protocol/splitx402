...
| Merchant SDK cached campaign resolver, payment IDs, operation digests, and receipt outbox | Started |
...
| `@split402/merchant-sdk` | Merchant-side cached campaign resolver, x402 payment-identifier helpers, operation digest helpers, durable receipt outbox, and control-plane ingestion retry helpers. |
