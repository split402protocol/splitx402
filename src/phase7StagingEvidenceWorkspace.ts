...
function createReadmeText(input: {
  ...
  return [
    ...
    "```",
    "",
    "Replace the commented command template with the real command transcript.",
    "Run commands-status before assembly to catch missing commands or placeholder output.",
