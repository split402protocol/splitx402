...
function createReadmeText(directory: string): string {
  return [
    ...
    "providerReferrerWallet, providerPayoutWallet, network, asset,",
    ...
    "routeId, commissionBps, protocolFeeBpsOfCommission,",
    ...
    "referrer wallet, payout wallet, required amount, and referrer credit.",
