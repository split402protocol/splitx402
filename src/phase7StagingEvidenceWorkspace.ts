...
function createReadmeText(input: {
  ...
  return [
    ...
    "```",
    "",
    "Use commands-record with --include-hosted on the same staging runtime after",
    "private env values are filled. It captures the hosted Docker, seed,",
    "collection, paid-suite, manifest, assemble, status, and validation command",
    "blocks into commands.log. Keep commands.log private and run commands-status",
