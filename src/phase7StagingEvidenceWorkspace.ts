...
function createReadmeText(directory: string): string {
  return [
    ...
    "providerAsset, providerAmountAtomic, providerPayToWallet, providerRouteId,",
    "network, asset, requiredAmountAtomic, payToWallet, amountPaidAtomic,",
    "receiptId, receiptVerificationStatus, executeExecutionMode,",
    "referrerCreditAtomic, receiptReferrerCreditAtomic, routeId, commissionBps,",
    ...
    "payToWallet plus matching receipt network, asset, payToWallet, routeId,",
    "required amount, and referrer credit.",
