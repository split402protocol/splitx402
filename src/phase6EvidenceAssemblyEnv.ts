...
export function createPhase6EvidenceAssemblyEnvTemplate(
  ...
  return [
    ...
    "# Review date, reviewers, source_commit, funding_wallet, and network can",
    "# also be derived from the generated image-provenance and signer-policy",
    ...
    "",
    "# Assemble and check:",
    `# corepack pnpm phase6:evidence:collect --evidence-env-file ${directory}/phase6-evidence.env`,
