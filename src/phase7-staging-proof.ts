...
try {
  ...
  const values = {
    ...
    hosted_preflight_evidence:
      process.env.SPLIT402_PHASE7_HOSTED_PREFLIGHT_EVIDENCE,
    agent_discovery_evidence:
      process.env.SPLIT402_PHASE7_AGENT_DISCOVERY_EVIDENCE,
    ...
    mcp_gateway_evidence: process.env.SPLIT402_PHASE7_MCP_GATEWAY_EVIDENCE,
