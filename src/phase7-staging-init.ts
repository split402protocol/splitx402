    ...
    JSON.stringify(
      {
        ...
        nextCommands: [
          ...
          `SPLIT402_PHASE7_SEED_CONFIRM=seed-hosted-staging corepack pnpm phase7:staging:seed > ${workspace.directory}/phase7-seed.json`,
          `corepack pnpm phase7:staging:apply-seed-env --seed-output ${workspace.directory}/phase7-seed.json --phase7-env ${envFilePath}`,
          ...
          `corepack pnpm phase7:staging:commands-record --include-hosted --force --evidence-env-file ${envFilePath} --evidence-dir ${workspace.directory} --proof phase7-staging-proof.txt --seed-output ${workspace.directory}/phase7-seed.json --output ${workspace.directory}/commands.log`,
