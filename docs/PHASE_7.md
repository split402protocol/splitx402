...
# and SPLIT402_MCP_CONTROL_PLANE_TOKEN. It also includes SPLIT402_MERCHANT_PAY_TO.
...
validation suite, including
`corepack pnpm product:launch-preflight --brief --workspace split402-launch-evidence`
and `corepack pnpm product:public-surface-check --brief`, so env readiness and
