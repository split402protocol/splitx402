...
The implementation baseline follows that architecture direction. It contains the
first implementation shape: protocol package, test vectors, x402 extension glue,
Express adapter, agent SDK, demo merchant, demo agent, and public demo runbooks.
