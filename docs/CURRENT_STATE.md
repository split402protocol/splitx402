...
| Control plane | Implemented foundation: receipt ingestion, merchant/campaign/route registries, wallet auth, PostgreSQL persistence, outbox workers, and chain verification. |
...
- Phase 6 still needs signer runtime wiring, payout webhooks, reconciliation for
  unknown outcomes, and referrer-facing payout history.
